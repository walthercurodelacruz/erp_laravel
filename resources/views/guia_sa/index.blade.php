    ...
    <div class="row">
        <div class="col-md-12 main-datatable">
            <div class="card_body">
                ...
                <div class="d-flex">
                    <div class="add_flex">
                    	<p>Listado de guias de salida</p>
                    </div>
                    <div class="createSegment">
                        @can('crear-guia-sa')
                         <a href="{{route('Guia_Sa.create')}}" class="btn dim_button create_new"><i class='bx bx-plus-medical' ></i>Crear nuevo</a>    
                        @endcan
                         <form method="GET">
                    ...
                    <table style="width:100%;" id="filtertable" class="table cust-datatable dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <td style="min-width:150px;">Ruc cliente</td>
                                <td style="min-width:150px;">Razon S.</td>
                                <td style="min-width:150px;">Fecha salida</td>
                                <td style="min-width:150px;">Archivo</td>
                                <td style="min-width:150px;">N° guia de salida</td>
                        ...
                        <tbody>
                            ...
                            <tr>
								<td><a href="{{route('Guia_Sa.show', $guia->id_guia)}}">{{$guia->cod_guia}}</a></td>
								<td>{{$guia->rucc_guia}}</td>
                                ...
                                <span class="actionCust">
                                        @can('editar-guia-sa')
                                        <a href="{{route('Guia_Sa.edit', $guia->id_guia)}}"><i class='bx bxs-edit-alt'></i></a>
                                        @endcan
                                    </span>
                                    <span class="actionCust add_flex">
                                        @can('borrar-guia-sa')
                                        <form action="{{route('Guia_Sa.destroy', $guia->id_guia)}}" method="post">
											@csrf
											@method('DELETE')
